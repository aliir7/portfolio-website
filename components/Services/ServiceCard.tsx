...
const ServiceCard = ({ title, subtitle, description }: Props) => {
  ...
  return (
    <div className="group bg-card border-border/60 hover:border-card-foreground relative flex min-h-88 flex-col overflow-hidden rounded-3xl border p-6 transition-all duration-300 dark:hover:border-primary hover:shadow-4px md:h-105 md:p-10">
      <div>
